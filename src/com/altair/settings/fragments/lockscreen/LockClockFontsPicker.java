/*
 * SPDX-FileCopyrightText: 2023 crDroid Android Project
 * SPDX-FileCopyrightText: 2023-2025 Altair ROM Project
...
public class LockClockFontsPicker extends SettingsPreferenceFragment {
    ...
    private final String mCategory = ThemeUtils.LOCKSCREEN_FONT_KEY;
    ...
    public static class Adapter extends RecyclerView.Adapter<Adapter.CustomViewHolder> {
        ...
        public CustomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.picker_option_lock_clock_font,
                    parent, false);
